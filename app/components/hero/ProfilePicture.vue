...
<template>
  <div class="z-10 mt-15 flex items-center justify-center">
    <SpotlightButton rounded>
      ...
      >
        <NuxtImg
          width="96"
          :src="profile.picture"
          class="size-40 rounded-full border-2 border-neutral-800/30 object-cover"
          alt="Michael Briquet Profile Picture"
          aria-label="Michael Briquet Profile Picture"
        />
      </div>
    </SpotlightButton>
  </div>
